//原理: Java集合ArrayList在开发中也很常用，也可以作为定位关键代码所在位置的方法之
...
// 使用Java.use获取java.util.ArrayList类的引用
    ...
    arrayList.add.overload('java.lang.Object').implementation = function(a){
        // 打印调用add方法时传递的参数a
        // if(a.equals("username=15658696890")){
        //     showStacks();
    ...
    arrayList.add.overload('int', 'java.lang.Object').implementation = function(index, a){
        // 打印调用add方法时传递的参数index, a
        console.log("arrayList.add: ", index, a);
        // 调用原始的add方法并返回其结果
        return this.add(index, a);
    }
